        ...
        <div class="container">
            <form action="confirm" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="input-add" name="fullname" value="{{ $inputs['fullname'] }}" />
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        女性<input class="custom-control-input" id="radioGender1" checked="checked" name="gender" type="radio" value="2">
                        @else
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input type="email" class="input-mail" name="email" value="{{ $inputs['email'] }}">
                    </div>
                </div>
                <div class="form-group row">
                    <p class="col-sm-4 col-form-label">郵便番号<span class="badge badge-danger ml-1">※</span></p>
                    <div class="col-sm-8">
                        〒<input type="text" oninput="value = value.replace(/[０-９]/g,s => String.fromCharCode(s.charCodeAt(0) - 65248)).replace(/[ー−]/g,'-').replace(/[^\-\d]/g,'');" name="postcode" size="10" maxlength="8" onKeyUp="AjaxZip3.zip2addr(this,'','address','address');" value="{{ $inputs['postcode'] }}"><br>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea name="option" value="{{ $inputs['option'] }}"></textarea>
                    </div>
                </div>
